...
export function ConciergePage() {
  ...
  return (
    <AppLayout>
        ...
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            <p className="text-lg text-gray-300 mb-10 leading-relaxed">
              Whether you're planning a fashion shoot in Paris, a wedding in Tuscany, or a music video in Tokyo – our team 
      ...
      {/* Testimonials Section - Full-width and properly centered */}
