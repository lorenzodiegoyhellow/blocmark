...
export function BookingEditFormNew({ booking, isOpen, onClose }: BookingEditFormProps): JSX.Element {
  ...
  console.log(`BookingEditFormNew - render - isOpen: ${isOpen}, bookingId: ${booking?.id}`);
  ...
  if (!isOpen || !booking) {
    console.log(`BookingEditFormNew - early return - isOpen: ${isOpen}, booking: ${booking ? 'exists' : 'missing'}`);
    return null;
  }
