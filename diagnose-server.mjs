// Simple diagnostic server for troubleshooting (ESM version)
// Run with: node diagnose-server.mjs
...
<html>
<head>
  <title>Diagnostic Server (ESM)</title>
  <meta charset="utf-8">
...
server.listen(PORT, '0.0.0.0', () => {
  console.log(`Diagnostic ESM server running at http://0.0.0.0:${PORT}/`);
